...
## 📌 プロジェクト概要
- **プロジェクト説明**: 言語交換WebプラットフォームにおけるリアルタイムチャットおよびAI機能の開発
...
### 💡 主な担当業務と成果
* **リアルタイムチャット機能の設計・実装**
  * Spring WebSocket を活用し、遅延を抑えたリアルタイムメッセージ送受信機能を実装しました。
* **チャットルーム管理およびメッセージ永続化機能の開発**
  * チャットルームの生成・管理機能と、会話履歴を保存するメッセージ永続化処理を実装しました。
* **AI 機能の統合**
  * Grok AI と連携し、AI自動応答、翻訳、文章校正機能をチャット内で利用できるように実装しました。
* **マルチメディア対応機能の実装**
  * 画像・音声送信機能を追加し、言語交換に適したコミュニケーション体験を提供しました。
## 💻 サイト画面 (Site Image)
